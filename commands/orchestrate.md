...
3. **PLAN**: Create the execution plan using `TodoWrite` with all tasks organized by parallel groups
...
- Zero unfinished work — every task must reach "completed" status before concluding
